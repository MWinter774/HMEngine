...
HMEngine::Core::FNTFile::BMFontCharacter HMEngine::Core::FNTFile::GetCharacter(int asciiCode)
{
	...
	{
		HMEngine::Core::Utilities::ThrowException("ASCII CODE " + std::to_string(asciiCode) + " DOESN'T EXIST IN FONT!\THE FONT: " + this->_fntFilePath);
	}
