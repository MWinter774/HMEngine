...
void HMEngine::Core::Rendering::Shaders::BillboardLabelShader::UpdateUniforms(const HMEngine::Core::Transform& transform)
{
...
HMEngine::Core::Rendering::Shaders::BillboardLabelShader::BillboardLabelShader() : _camera(&HMEngine::Core::Rendering::Camera::GetInstance()),
_projectionMatrix(HMEngine::GameSettings::GetProjectionMatrix())
{
	std::string vs = "./resources/shaders/billboardLabelShader.vs";
	std::string fs = "./resources/shaders/billboardLabelShader.fs";
...
HMEngine::Core::Rendering::Shaders::BillboardLabelShader::~BillboardLabelShader()
{
}