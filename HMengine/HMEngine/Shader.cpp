...
/*
template<typename T>
static T& HMEngine::Core::Rendering::Shaders::Shader<typename T>::GetInstance()
{
...
GLuint HMEngine::Core::Rendering::Shaders::BasicShader::LoadShader(GLenum shaderType, const std::string& shaderFile)
{
	std::ifstream ifs;
...
GLuint HMEngine::Core::Rendering::Shaders::BasicShader::CreateShaderProgram(std::vector<GLuint> shaders)
{
