...
float HMEngine::GameSettings::fovInDegrees = 45.0f;
unsigned int HMEngine::GameSettings::windowWidth = 800U;
unsigned int HMEngine::GameSettings::windowHeight = 600U;
glm::mat4 HMEngine::GameSettings::projectionMatrix = glm::perspective(glm::radians(HMEngine::GameSettings::fovInDegrees), float(HMEngine::GameSettings::windowWidth) / float(HMEngine::GameSettings::windowHeight), HMEngine::GameSettings::zNear, HMEngine::GameSettings::zFar);
